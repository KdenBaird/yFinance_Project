...
# TODO:  have a global constant var be intraday start and end time. 
...
"""
 ...
 TODO: When a user enters intraday data, e.g. 10 - 11. the data being gathered is actualy 10 - 11:05. (It's getting the 11:00 5m candle data too.)
 if you want dat from 10- 11:00 enter in terminal start time 10:00 end time 9:55. Or fix this by dropping rows where timestamp is 11:00:00-4:00
"""
...
def main():
    ...
    # daily_hod_lod_df = get_data.find_daily_hod_lod_times(daily_data)
    ...
    if intraday_choice == 'yes':
        ...
        # intraday_data, intraday_1m_data = get_data.get_intraday_data(ticker_input, start_date, end_date, intraday_start_time, intraday_end_time)
        # if lookback_input > 59:
        #     intraday_data = get_data.get_extended_intraday_data(intraday_data, ticker_input, start_date, end_date)
        #     print('This is extended data')
        #     print(intraday_data)
        ...
        if intraday_data is None: # get_data.get_intraday_data() offers the user the opportunity to make intraday_data to None
            ...
            bullish_fvgs = get_data.check_intraday_bullish_fvgs(intraday_data)
            bearish_fvgs = get_data.check_intraday_bearish_fvgs(intraday_data)
